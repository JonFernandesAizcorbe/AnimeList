...
def init_db():
    ...
    try:
        ...
        default_actor_list = [
            ...
            ActorORM(name="Aoi Ichikawa", birth=date(1991, 10, 2), gender="Masculino", hometown="Fukuoka Prefecture, Japan", bio="", height="", image="https://s4.anilist.co/file/anilistcdn/staff/large/n122966-tLhs84yYwoAs.png"),
            ActorORM(name="Katsuyuki Konishi", birth=date(1973, 4, 21), gender="Masculino", hometown="Wakayama, Japan", bio="", height="", image="https://s4.anilist.co/file/anilistcdn/staff/large/n95020-uOJO2IlwpcX0.png"),
            ActorORM(name="Yoshitsugu Matsuoka", birth=date(1986, 9, 17), gender="Masculino", hometown="Obihiro, Hokkaido Prefecture, Japan", bio="Un actor de voz actualmente afiliado a I'm Enterprise. Fue galardonado en la 6.ª edición de los Seiyu Awards como Mejor Actor Revelación en 2012 y en la 10.ª edición de los Seiyu Awards como Mejor Actor Principal en 2016.", height="165", image="https://s4.anilist.co/file/anilistcdn/staff/large/n106817-mioGQjbTWWQ6.png"),
            ActorORM(name="Yumiri Hanamori", birth=date(1997, 9, 29), gender="Femenino", hometown="Kanagawa Prefecture, Japan", bio="", height="157", image="https://s4.anilist.co/file/anilistcdn/staff/large/n116543-ugu1HZWiQkqi.jpg"),
            ActorORM(name="Miku Itou", birth=date(1996, 10, 12), gender="Femenino", hometown="Tokyo, Japan", bio="Miku se unió a la unidad idol StylipS el 27 de abril de 2013 y es la mitad de su subunidad, Pyxis, junto con Moe Toyota. Los pasatiempos de Miku incluyen ver anime, bailar y jugar Hyakunin Isshu. También practica kendo (aunque está en el nivel más bajo) y disfruta de la actuación. Es fan de Kamen Rider, y su rider favorito es Den-O.", height="", image="https://s4.anilist.co/file/anilistcdn/staff/large/n118581-8tQ3U5oTXTTQ.jpg"),
            ActorORM(name="Toshiyuki Morikawa", birth=date(1967, 1, 26), gender="Masculino", hometown="Kanagawa, Japan", bio="", height="172", image="https://s4.anilist.co/file/anilistcdn/staff/large/n95006-hoLuiZANeD3Q.png"),
            ActorORM(name="Masakazu Morita", birth=date(1972, 10, 21), gender="Masculino", hometown="Tokyo, Japan", bio="", height="", image="https://s4.anilist.co/file/anilistcdn/staff/large/n95205-5P3tKe3eTG9n.jpg"),
            ActorORM(name="Fumiko Orikasa", birth=date(1974, 12, 27), gender="Femenino", hometown="Tokyo, Japan", bio="Es una actriz de voz actualmente afiliada a Atomic Monkey. Como cantante, está bajo contrato con Rondo Robe.", height="", image="https://s4.anilist.co/file/anilistcdn/staff/large/n95152-X9K5ciNGSX35.jpg"),
        ...
        # Create characters
        #  CharacterORM(name="", age="", gender="", bio="", actor_id=actors_name.get(""), animes=[animes_dict[""], animes_dict[""], animes_dict[""], animes_dict[""], animes_dict[""], animes_dict[""], animes_dict[""], animes_dict[""], animes_dict[""]], image=""),
        ...
        animes_dict = {anime.name: anime for anime in animes}

        default_character_list = [
            CharacterORM(name="Frieren", age="1000+", gender="Femenino", bio="Frieren es la protagonista de Sousou no Frieren y la maestra de Fern. Fue la maga del Grupo de Héroes y viajó junto al Héroe Himmel, el Guerrero Eisen y el Sacerdote Heiter en un viaje de 10 años para derrotar al Rey Demonio. Desde joven, fue una prodigio de la magia, con una cantidad impresionante de maná, lo que llamó la atención de Flamme, un mago humano que le enseñó todo lo que había que saber sobre magia y control de maná hasta que falleció. Frieren continúa recopilando conocimientos de magia, sin importar lo triviales que puedan parecer.", actor_id=actors_name.get("Atsumi Tanezaki"), animes=[animes_dict["Sousou no Frieren"]], image="https://s4.anilist.co/file/anilistcdn/character/large/b176754-PCnpqIOkjhFk.png"),
            CharacterORM(name="Fern", age="18", gender="Femenino", bio="Fern es la joven aprendiz de maga de Frieren y la acompaña como miembro de su grupo. Es una refugiada de guerra huérfana, originaria de las Tierras del Sur, que posteriormente fue adoptada por Heiter y puesta bajo el cuidado de Frieren.", actor_id=actors_name.get("Kana Ichinose"), animes=[animes_dict["Sousou no Frieren"]], image="https://s4.anilist.co/file/anilistcdn/character/large/b183965-uGFohBjlFoTp.png"),
            CharacterORM(name="Stark", age="18", gender="Masculino", bio="Stark es un guerrero que lucha junto a Frieren y Fern. Tras el ataque de demonios a su aldea, huyó y se convirtió en aprendiz de Eisen. Siguiendo instrucciones de Eisen, se unió al grupo de Frieren como vanguardia.", actor_id=actors_name.get("Chiaki Kobayashi"), animes=[animes_dict["Sousou no Frieren"]], image="https://s4.anilist.co/file/anilistcdn/character/large/b184313-CQl6GSt4RSny.jpg"),
            CharacterORM(name="Himmel", age="", gender="Masculino", bio="Héroe y líder del grupo que derrotó al Rey Demonio, y un apuesto narcisista que se autoproclama. Se preocupa por sus amigos y no puede evitar ayudar a quienes lo necesitan. Tuvo una gran influencia en Frieren, con quien compartió aventuras durante 10 años.", actor_id=actors_name.get("Nobuhiko Okamoto"), animes=[animes_dict["Sousou no Frieren"]], image="https://s4.anilist.co/file/anilistcdn/character/large/b184311-wQFySqYXEqf1.png"),
            CharacterORM(name="Heiter", age="", gender="Masculino", bio="Un sacerdote que forma parte del grupo del Héroe. Más tarde cuidó de Fern hasta la llegada de Frieren.", actor_id=actors_name.get("Hiroki Touchi"), animes=[animes_dict["Sousou no Frieren"]], image="https://s4.anilist.co/file/anilistcdn/character/large/b184310-tiXvrq4FINXP.jpg"),
            CharacterORM(name="Eisen", age="", gender="Masculino", bio="Guerrero enano que formó parte del grupo del Héroe y luego se convirtió en mentor de Stark.", actor_id=actors_name.get("Youji Ueda"), animes=[animes_dict["Sousou no Frieren"]], image="https://s4.anilist.co/file/anilistcdn/character/large/b184312-kxd5H6iOHIq4.png"),
            CharacterORM(name="Rudo", age="15", gender="Masculino", bio="Rudo es el hijo adoptivo de Regto. Originalmente provenía de los barrios marginales de la Esfera, pero terminó siendo condenado al Abismo tras ser falsamente acusado de asesinato. Debido a haber sido maltratado físicamente y abandonado por sus padres biológicos, Rudo es emocionalmente reservado e introvertido y tiene cicatrices permanentes y dolorosas en sus manos; por ello debe mantenerlas cubiertas con vendas y un par de guantes que Regto le regaló para ayudar a aliviar el dolor insoportable.", actor_id=actors_name.get("Aoi Ichikawa"), animes=[animes_dict["Gachiakuta"]], image="https://s4.anilist.co/file/anilistcdn/character/large/b266433-8JWks5k2OPJn.png"),
            CharacterORM(name="Enjin", age="28", gender="Masculino", bio="Enjin es del Abismo y el hombre que salvó a Rudo cuando cayó del cielo. Tiene una personalidad muy alegre y divertida, pero muy poca energía, y aparentemente es tranquilo y relajado. A pesar de sus increíbles habilidades, se refiere a sí mismo como “un conserje promedio”.", actor_id=actors_name.get("Katsuyuki Konishi"), animes=[animes_dict["Gachiakuta"]], image="https://s4.anilist.co/file/anilistcdn/character/large/b266438-3Veykti1lXgg.png"),
            CharacterORM(name="Zanka Nijiku", age="17", gender="Masculino", bio="Es un exaprendiz de la Guardia del Infierno y actualmente es miembro de la facción Akuta de los Limpiadores.", actor_id=actors_name.get("Yoshitsugu Matsuoka"), animes=[animes_dict["Gachiakuta"]], image="https://s4.anilist.co/file/anilistcdn/character/large/b268742-PSWLnWDJH7HJ.png"),
            CharacterORM(name="Riyou Reaper", age="16", gender="Femenino", bio="Es una exasesina a sueldo y actualmente es miembro de la facción Akuta de los Limpiadores. Tiene un estilo de combate inusual en el que empuña sus grandes tijeras con los pies. Normalmente es alegre y juguetona, pero en combate se vuelve sorprendentemente pragmática.", actor_id=actors_name.get("Yumiri Hanamori"), animes=[animes_dict["Gachiakuta"]], image="https://s4.anilist.co/file/anilistcdn/character/large/b266434-Wkjo1jlTgDCm.jpg"),
            CharacterORM(name="Chiwa", age="", gender="Femenino", bio="Una chica que vive en los barrios bajos de la Esfera. A Rudo le gusta por la forma en que parece preocuparse y cuidar de él.", actor_id=actors_name.get("Miku Itou"), animes=[animes_dict["Gachiakuta"]], image="https://s4.anilist.co/file/anilistcdn/character/large/b275749-fglzDjaLZh1H.png"),
            CharacterORM(name="Regto", age="", gender="Masculino", bio="El hombre que crió a Rudo después de que perdió a sus padres. Le dio a Rudo un par de guantes.", actor_id=actors_name.get("Toshiyuki Morikawa"), animes=[animes_dict["Gachiakuta"]], image="https://s4.anilist.co/file/anilistcdn/character/large/b266437-sUIpywq7P310.jpg"),
            CharacterORM(name="Ichigo Kurosaki", age="16", gender="Masculino", bio="Ichigo Kurosaki es un adolescente de cabello naranja que vive en la ciudad de Karakura y es un estudiante competente en su instituto. Pero, más importante aún, es un Shinigami sustituto. Desde que era joven, Ichigo ha sido capaz de ver espíritus, hasta el punto de no poder distinguir entre los vivos y los muertos. Debido a esta extraña habilidad, termina conociendo a Rukia Kuchiki, una Shinigami. Poco después, cuando un Hollow aparece y amenaza a su familia, Ichigo lucha imprudentemente contra él, obligando a Rukia a salvarlo al recibir el ataque en su lugar. Al ver la determinación de Ichigo por proteger a su familia, Rukia le ofrece convertirlo temporalmente en un Shinigami atravesando su pecho con su Zanpakutō y transfiriéndole la mitad de su poder. Ichigo acepta, lo que le permite derrotar fácilmente al Hollow y lo obliga a cumplir el papel de Rukia como Shinigami hasta que ella recupere sus poderes. Siendo terco, de mal genio, de voluntad fuerte e impulsivo, Ichigo suele afirmar que no le importa lo que los demás piensen de él, e intenta mantener una imagen distante y “cool”. Generalmente mantiene el rostro con una expresión de enfado casi permanente, con las cejas fruncidas. Su carácter directo y explosivo es algo que él mismo reconoce, y si alguien busca pelea con él, no puede evitar responder. La determinación de Ichigo en combate puede flaquear en ocasiones, lo que afecta su rendimiento, y tiende a caer en un estado de depresión y autodesprecio cuando pierde una pelea importante o decepciona a un amigo. A pesar de lo que aparenta, es genuinamente compasivo y empático con los demás, y no le importa ayudar cuando alguien está mal o necesita apoyo. Siempre está dispuesto a luchar para proteger a quienes le importan, sin importar contra qué tenga que enfrentarse.", actor_id=actors_name.get("Masakazu Morita"), animes=[animes_dict["BLEACH"]], image="https://s4.anilist.co/file/anilistcdn/character/large/b5-a7bkJgjhhigE.png"),
            CharacterORM(name="Rukia Kuchiki", age="", gender="Femenino", bio="Rukia es una Shinigami de la Sociedad de Almas que conoció y salvó la vida de Ichigo Kurosaki al prestarle su poder espiritual. Después de salvarlo, se ve obligada a permanecer temporalmente en el mundo humano, utilizando un gigai que le dio Kisuke Urahara hasta que pueda recuperar su fuerza y regresar a la Sociedad de Almas. Decide vivir con Ichigo para vigilarlo y tener un lugar donde quedarse. También es la teniente de la 13ª División del Gotei 13, sirviendo bajo el capitán Juushirou Ukitake. Nacida inicialmente en una clase baja, Rukia conserva su modestia, a pesar de ser miembro adoptado de un linaje noble. Es elegante y “refinada”, pero está dispuesta a hablar con personas comunes. Sin embargo, su actitud fría y solitaria a menudo la obliga a ocultar sus problemas personales, incluso de quienes están cerca de ella. Debido a que nunca abre completamente su corazón, le cuesta hacer amigos. A veces también puede comportarse como una marimacho, queriendo demostrar que es fuerte y volviéndose agresiva cuando alguien la insulta. Rukia desconoce las costumbres del mundo humano moderno, lo que la lleva a tener malentendidos y dificultades con cosas tan simples como abrir un zumo. Le gusta subirse a lugares altos y le encantan los conejos, volviéndose bastante sensible cuando alguien critica su afición por ellos. A menudo, a la gente le cuesta entender sus dibujos, que suelen parecer conejos, y no le gusta que se quejen de su calidad.", actor_id=actors_name.get("Fumiko Orikasa"), animes=[animes_dict["BLEACH"]], image="https://s4.anilist.co/file/anilistcdn/character/large/b6-25WoBeWMZXBc.png"),
        ]
