...
def init_db():
    ...
    try:
        ...
        default_character_list = [
            ...
            CharacterORM(name="Heiter", age="", gender="Masculino", bio="Un sacerdote que forma parte del grupo del Héroe. Más tarde cuidó de Fern hasta la llegada de Frieren.", actor_id=actors_name.get("Hiroki Touchi"), anime_id=animes_name.get("Frieren"), image="https://s4.anilist.co/file/anilistcdn/character/large/b184310-tiXvrq4FINXP.jpg"),
