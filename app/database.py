...
def init_db():
    ...
    try:
        ...
        default_character_list = [
            CharacterORM(name="Frieren", age="1000+", gender="Femenino", bio="Frieren es la protagonista de Sousou no Frieren y la maestra de Fern. Fue la maga del Grupo de Héroes y viajó junto al Héroe Himmel, el Guerrero Eisen y el Sacerdote Heiter en un viaje de 10 años para derrotar al Rey Demonio. Desde joven, fue una prodigio de la magia, con una cantidad impresionante de maná, lo que llamó la atención de Flamme, un mago humano que le enseñó todo lo que había que saber sobre magia y control de maná hasta que falleció. Frieren continúa recopilando conocimientos de magia, sin importar lo triviales que puedan parecer.", actor_id=actors_name.get("Atsumi Tanezaki"), anime_id=animes_name.get("Sousou no Frieren"), image="https://s4.anilist.co/file/anilistcdn/character/large/b176754-PCnpqIOkjhFk.png"),
            CharacterORM(name="Fern", age="18", gender="Femenino", bio="Fern es la joven aprendiz de maga de Frieren y la acompaña como miembro de su grupo. Es una refugiada de guerra huérfana, originaria de las Tierras del Sur, que posteriormente fue adoptada por Heiter y puesta bajo el cuidado de Frieren.", actor_id=actors_name.get("Kana Ichinose"), anime_id=animes_name.get("Sousou no Frieren"), image="https://s4.anilist.co/file/anilistcdn/character/large/b183965-uGFohBjlFoTp.png"),
            CharacterORM(name="Stark", age="18", gender="Masculino", bio="Stark es un guerrero que lucha junto a Frieren y Fern. Tras el ataque de demonios a su aldea, huyó y se convirtió en aprendiz de Eisen. Siguiendo instrucciones de Eisen, se unió al grupo de Frieren como vanguardia.", actor_id=actors_name.get("Chiaki Kobayashi"), anime_id=animes_name.get("Sousou no Frieren"), image="https://s4.anilist.co/file/anilistcdn/character/large/b184313-CQl6GSt4RSny.jpg"),
            CharacterORM(name="Himmel", age="", gender="Masculino", bio="Héroe y líder del grupo que derrotó al Rey Demonio, y un apuesto narcisista que se autoproclama. Se preocupa por sus amigos y no puede evitar ayudar a quienes lo necesitan. Tuvo una gran influencia en Frieren, con quien compartió aventuras durante 10 años.", actor_id=actors_name.get("Nobuhiko Okamoto"), anime_id=animes_name.get("Sousou no Frieren"), image="https://s4.anilist.co/file/anilistcdn/character/large/b184311-wQFySqYXEqf1.png"),
            CharacterORM(name="Heiter", age="", gender="Masculino", bio="Un sacerdote que forma parte del grupo del Héroe. Más tarde cuidó de Fern hasta la llegada de Frieren.", actor_id=actors_name.get("Hiroki Touchi"), anime_id=animes_name.get("Sousou no Frieren"), image="https://s4.anilist.co/file/anilistcdn/character/large/b184310-tiXvrq4FINXP.jpg"),
            CharacterORM(name="Eisen", age="", gender="Masculino", bio="Guerrero enano que formó parte del grupo del Héroe y luego se convirtió en mentor de Stark.", actor_id=actors_name.get("Youji Ueda"), anime_id=animes_name.get("Sousou no Frieren"), image="https://s4.anilist.co/file/anilistcdn/character/large/b184312-kxd5H6iOHIq4.png"),
        ]
