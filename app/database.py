...
def init_db():
    ...
    try:
        ...
        default_actor_list = [
            ...
            ActorORM(name="Yoshitsugu Matsuoka", birth=date(1986, 9, 17), gender="Masculino", hometown="Obihiro, Hokkaido Prefecture, Japan", bio="Un actor de voz actualmente afiliado a I'm Enterprise. Fue galardonado en la 6.ª edición de los Seiyu Awards como Mejor Actor Revelación en 2012 y en la 10.ª edición de los Seiyu Awards como Mejor Actor Principal en 2016.", height="165", image="https://s4.anilist.co/file/anilistcdn/staff/large/n95020-uOJO2IlwpcX0.png"),
